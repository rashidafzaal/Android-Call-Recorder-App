...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	// Contacts table name
	private static final String TABLE_CONTACTS = "mycallhistory";
	...
	private static final String KEY_IS_INCOMING = "is_incoming";
	...
	void addContact(Contact contact) {
		...
		values.put(KEY_IS_INCOMING, contact.getIsIncoming());
		values.put(KEY_FAV, contact.getFavourite());
	...
	public List<Contact> getAllContacts() {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				contact.setIsIncoming(cursor.getString(4));
				contact.setFavourite(cursor.getString(5));
				contact.setPath(cursor.getString(6));
...
// Adding contact to list
	...
	// Updating single contact
	public int updateRename(Contact contact) {
		SQLiteDatabase db = this.getWritableDatabase();
